...
- Add a verified startup patch that bypasses the client stipulation login notification

### Changed

- Rename client and server message types and files to match their wire command names, with `ServerSystemMessage` for the server `Message` command
